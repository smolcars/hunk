    ...
    fn rows(&self) -> Vec<SettingsShortcutRow> {
        vec![
            ...
            SettingsShortcutRow {
                ...
                hint: "Starts another terminal tab in the active terminal panel.",
                input_state: self.terminal_new_tab.clone(),
            },
            SettingsShortcutRow {
                id: "terminal-close-tab",
                label: "Terminal: Close Tab",
                hint: "Closes the active terminal tab.",
                input_state: self.terminal_close_tab.clone(),
            },
            SettingsShortcutRow {
                id: "terminal-next-tab",
                label: "Terminal: Next Tab",
                hint: "Moves to the next terminal tab.",
                input_state: self.terminal_next_tab.clone(),
            },
            SettingsShortcutRow {
                id: "terminal-previous-tab",
                label: "Terminal: Previous Tab",
                hint: "Moves to the previous terminal tab.",
                input_state: self.terminal_previous_tab.clone(),
            },
            SettingsShortcutRow {
                id: "open-project",
                label: "Open Project",
