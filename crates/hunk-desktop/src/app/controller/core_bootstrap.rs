...
impl DiffViewer {
    ...
    pub(super) fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
        ...
        let mut view = Self {
            ...
            ai_terminal_active_tab_id: 1,
            ai_terminal_next_tab_id: 2,
            ai_terminal_tabs: default_terminal_tabs(),
            ...
            files_terminal_active_tab_id: 1,
            files_terminal_next_tab_id: 2,
            files_terminal_tabs: default_terminal_tabs(),
