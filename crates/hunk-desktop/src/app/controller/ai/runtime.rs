...
impl DiffViewer {
    ...
    fn ai_model_by_id(&self, model_id: &str) -> Option<&hunk_codex::app_server_protocol::Model> {
    ...
    pub(crate) fn current_ai_model_supports_image_inputs(&self) -> bool {
        self.current_ai_model_for_input_modalities()
            .is_none_or(|model| {
                model
                    .input_modalities
                    .contains(&hunk_codex::codex_protocol::openai_models::InputModality::Image)
            })
    }

    fn current_ai_model_for_input_modalities(&self) -> Option<&hunk_codex::app_server_protocol::Model> {
