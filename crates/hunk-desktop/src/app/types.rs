...
struct AiWorkspaceState {
    ...
    rate_limits: Option<hunk_codex::app_server_protocol::RateLimitSnapshot>,
    models: Vec<hunk_codex::app_server_protocol::Model>,
    experimental_features: Vec<hunk_codex::app_server_protocol::ExperimentalFeature>,
    collaboration_modes: Vec<hunk_codex::app_server_protocol::CollaborationModeMask>,
    skills: Vec<hunk_codex::app_server_protocol::SkillMetadata>,
