...
struct AiPerfWindow {
    ...
    workspace_session_refresh: AiPerfDurationStats,
    workspace_session_cache_hits: u32,
    workspace_surface_geometry_rebuild: AiPerfDurationStats,
    workspace_surface_text_layout_build: AiPerfDurationStats,
    workspace_surface_text_layout_builds: u64,
    workspace_surface_text_layout_cache_hits: u64,
    workspace_inline_diff_projection_build: AiPerfDurationStats,
    workspace_inline_diff_projection_builds: u64,
    workspace_inline_diff_projection_cache_hits: u64,
